...

{
...

	{
		...
		if(wordCount == 2) //If more than one word, space positions will be used
			{
				...
				for(index = 0; index <= reverseSentence.length() -1; index ++)
					...
					// Count of characters per word and comparing with charMax and charMin
		...
		else //If sentence is one word, no space positions will be used
			{
				firstWord = sentence;
